 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |LCtl/Esc| A    | S    | D    | F    | G    |------|           |------| H    | J    | K    | L    | Ö    | Ä      |
 * |--------+------+------+------+------+------| *    |           | Meh  |------+------+------+------+------+--------|
 * | LShft  | Z    | X    | C    | V    | B    |      |           |      | N    | M    | ,    | .    | -    | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | LCtl |  ^   | *    | LAlt | LGui |                                       | AltGr| Left | Down |  Up  | Right|
 *   | (')  |  " ~ | '  ´ |      |      |                                       |      |      |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,--------------.
 *                                        | LCtl | RCtl |       | Home |   End  |
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
    // left hand
    KC_DELT,         KC_1,     KC_2,     KC_3,    KC_4,    KC_5,   KC_F11,
    ...
    // right hand
         ...
         MEH_T(KC_NO), KC_N,   KC_M,    KC_COMM, KC_DOT,  NO_MINS,  KC_RSPC,
                               NO_ALGR, KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT,
         KC_HOME, KC_END,
         KC_PGUP,
...
[SYMB] = LAYOUT_ergodox(
       // left hand
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, NO_LESS, LSFT(NO_LESS), KC_TRNS,
       KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   NO_PIPE, KC_TRNS,
       KC_TRNS, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_TRNS,
       KC_TRNS, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, NO_LESS,LSFT(NO_LESS),
                                       KC_TRNS,KC_TRNS,
                                               KC_TRNS,
